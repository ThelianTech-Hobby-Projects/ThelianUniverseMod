package thelianuniverse.api.config;
...
import thelianuniverse.api.config.properties.ConfigProperty;
import thelianuniverse.api.config.properties.ConfigPropertyArray;
import thelianuniverse.api.config.properties.ConfigPropertyArray.*;
import thelianuniverse.api.config.properties.ConfigPropertyBoolean;
import thelianuniverse.api.config.properties.ConfigPropertyFloat;
import thelianuniverse.api.config.properties.ConfigPropertyInteger;
import thelianuniverse.api.config.properties.ConfigPropertyString;
...
public abstract class Config {
    ...
    public final ConfigPropertyArray.ConfigPropertyArrayInteger addProperty(ConfigPropertyArrayInteger property) {
        this.addProp(property);
        return property;
    }

    public final ConfigPropertyArray.ConfigPropertyArrayDouble addProperty(ConfigPropertyArrayDouble property) {
        this.addProp(property);
        return property;
    }

    public final ConfigPropertyArray.ConfigPropertyArrayString addProperty(ConfigPropertyArrayString property) {
        this.addProp(property);
        return property;
    }
    ...
    public void loadConfig() {
        ...
        try {
            ...
            Logger.error("ThelianUniverse had a problem loading config: {}", configFile);
        }
        finally {
